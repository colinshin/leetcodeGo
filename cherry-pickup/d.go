...
先得到(r1, c1), (r2, c2)两处的樱桃总数（如果位置重复则只算一次）； 再加上max(dp[r1+1][c1][c2]，dp[r1][c1+1][c2]，dp[r1+1][c1][c2+1]，dp[r1][c1+1][c2+1])
说明：max(dp[r1+1][c1][c2]，dp[r1][c1+1][c2]，dp[r1+1][c1][c2+1]，dp[r1][c1+1][c2+1])代表a，b两个人向下或右移动的四种可能：
a, b都向下： dp[r1+1][c1][c2]
a右b下：dp[r1][c1+1][c2]
a下b右：dp[r1+1][c1][c2+1]
a，b都向右：dp[r1][c1+1][c2+1]
*/
