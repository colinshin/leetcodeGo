...
func confusingNumber(N int) bool {
	confusingNumber := caculateConfusingNumber(N)
	return confusingNumber != -1 && confusingNumber != N
}

func caculateConfusingNumber(n int) int {
	if n < 0 {
		return -1
	}
