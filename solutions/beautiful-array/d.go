...
因每次翻倍构造，会有写多余的元素（大于N），最后需要剔除这些元素
...
首先我们可以发现一个不错的性质，如果某个数组 [a_1, a_2, \cdots, a_n][a1,a2,⋯,an] 是漂亮的，
那么对这个数组进行仿射变换，得到的新数组 [ka_1+b, ka_2+b, \cdots, ka_n+b][ka1+b,ka2+b,⋯,kan+b] 也是漂亮的（其中 k ！= 0）。
