...
1。然后判断reader.get(right), 如果比target大，说明范围需要扩大
2。这时候可让left=right，为了尽快锁定范围，right可以翻倍
一直循环执行1和2，直到找到>=target的right（此时left是前一个right，正好是right的一半）
*/
